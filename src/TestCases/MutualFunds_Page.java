...
public class MutualFunds_Page {
	...
	@org.testng.annotations.BeforeClass
	       ...
	       fLib.readObjectRepository("MutualFundsPage");
	       }
...
public void MutualFunds_MonthScoreCard_VerifyColorAndValue() {
	...
	boolean isVerifyValueCorpusGainers = obj_mutualfundspage.verifyValueCorpusGainers(driver);
  ...
  @Test
	public void MutualFunds_CompareFunds_VerifyTextAndGraph() throws Throwable  {
		...
		boolean isCompareFundsGraph =obj_mutualfundspage.compareFundsGraph(driver);
