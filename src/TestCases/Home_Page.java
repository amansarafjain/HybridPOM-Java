...
public class Home_Page{
	...
	@org.testng.annotations.BeforeClass
	      ...
	      // System.out.println("Before Class");
	       fLib.readObjectRepository("HomePage");
	       }
	...
	public void verifyHomeTabCal() throws Exception {
		try {
			...
			boolean isVerifyLogoImage = homePage.verifyLogoImage(driver);	
			...
			boolean isVerifyTabDisplay = homePage.verifyTabDisplay(driver);
			...
			boolean isVerifyTabsquence = homePage.verifyTabsquence(driver);
			...
			homePage.clickOnSquareButton(driver);
			
			//Verify Latest News Section
			LoggerInstance.logger.info("Verify latest newes section.");
			boolean isVerifyLatestNewsSection = homePage.verifyLatestNewsSection(driver);
			...
			boolean isVerifySearchOnHomePage = homePage.verifySearchOnHomePage(driver);
