...
public class Reports_Page {
	...
	@org.testng.annotations.BeforeClass
	     ...
	     //  System.out.println("Before Class");
	       fLib.readObjectRepository("ReportPage");
	       }
	...
	public void Reports_ResearchReports_VerifyReportsPage() throws Exception{
		...
		obj_reportPage.clickOnResearchReportstab(driver);
		...
		obj_reportPage.switchOfNewWindow(driver);
	...
	try
	{
		...
		boolean isVerifyDailyMarketWrapPageIsdisplayed =obj_reportPage.VerifyDailyMarketWrapPageIsdisplayed(driver);
		...
		boolean isVerifyCNXTableIsdisplayed = obj_reportPage.VerifyCNXTableIsdisplayed(driver);
		...
		boolean isVerifyBSESensexTableIsdisplayed = obj_reportPage.VerifyBSESensexTableIsdisplayed(driver);
		...
		//Verify The CNX Table date
     	...
     	boolean isVerifyCNXEffectiveDateDisplayed = obj_reportPage.VerifyCNXEffectiveDateDisplayed(driver);
		...
		boolean isVerifyBSESensexTableDateDisplayed =obj_reportPage.VerifyBSESensexTableDateDisplayed(driver);
		...
		boolean isVerifyDailyWrapFrameContainsHeading = obj_reportPage.VerifyDailyWrapFrameContainsHeading(driver);
	...
	public void verifyweeklywraplink() throws Exception {
		...
		String url = null;
		try {
			LoggerInstance.logger.info("***********************verifyweeklywraplink() Started*********************************");
			obj_reportPage = PageFactory.initElements(driver, ReportsPage.class);
			//verifying weekly wrap link
			LoggerInstance.logger.info("verifying weekly wrap link");
			boolean isVerifyweeklyWraplink = obj_reportPage.verifyweeklyWraplink(driver);	
			...
			boolean isVerify_table_headers = obj_reportPage.verify_table_headers(driver);
			...
			obj_reportPage.clickOnweeklyWraplink(driver);		
			//verifying RHP tables of report tab
			LoggerInstance.logger.info("verifying RHP tables of report tab");
			boolean isVerify_right_hand_tables = obj_reportPage.verify_right_hand_tables(driver);
			...
			boolean isVerify_index_link_navigates_marketToday_page = obj_reportPage.verify_index_link_navigates_marketToday_page(driver);
			...
			LoggerInstance.logger.info("***********************verifyweeklywraplink() Finished*********************************");
