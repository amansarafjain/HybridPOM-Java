...
public class Market_Page {
	...
	WebDriver driver;
	InputData obj_inputData=new InputData();
	...
	fLib.readObjectRepository("MarketPage");
	}
	...
	public void Market_VerifyMarketTab(){
		...
		obj_marketPage.clickOnMarketTab(driver);
		...
		// Click On BSE Tab.
		obj_marketPage.clickOnBSETab(driver);
		...
		// Click On NSE Tab.
		obj_marketPage.clickOnNSETab(driver);
	...
	public void Market_VerifyETFTab() throws InterruptedException{
		try {
			...
			String var_dropdown1=obj_inputData.readInputData("Underlying NonGold");
			String var_dropdown2=obj_inputData.readInputData("Underlying Gold");
		...
		obj_marketPage.selectValueFromUnderlying(driver, var_dropdown1);
		...
		obj_marketPage.selectValueFromUnderlying(driver, var_dropdown2);
		...
		boolean isVerifyNegativeValueColor = obj_marketPage.verifyNegativeValueColor(driver);
